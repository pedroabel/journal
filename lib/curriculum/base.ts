...
export const BASE: Trilha = {
  ...
  { id:'base.din', t:'Dinheiro do dia a dia', filhos:[
    ...
    { id:'base.din.res', t:'A reserva pessoal como dívida', min:20, pre:['base.din.orc'],
      nota:'R$1.200/mês próprios, prioridade sobre a escada do visto, fecha ~mai/2027. Tratada como dívida de propósito: é o que impede um imprevisto de comer o dinheiro do intercâmbio.',
      saber:['as duas saídas separadas na conta: R$1.200 reserva, R$2.500 escada','saber que em mês apertado quem cede é a escada, nunca a reserva'] },
    { id:'base.din.preco', t:'O preço de um mês apertado', min:20, pre:['base.din.res'],
      nota:'A escada não tem folga: 24 depósitos cheios batem os R$60.000 em cima da data de comprovar fundos.',
      saber:['saber que cada mês sem os R$2.500 empurra a comprovação, e com ela visto e passagem','aceitar isso como decisão, não descobrir depois'] },

...
export const CS50: Trilha = {
  ...
  { id:'cs50.w2', t:'Week 2 — Arrays', nota:'Onde C começa a cobrar: string é array de char terminado em nulo.', filhos:[
    { id:'cs50.w2.arr', t:'Arrays e passagem para função', min:20,
    ...
    { id:'cs50.w2.pset2', t:'Pset 2 — Caesar ou Substitution', min:90, pre:['cs50.w2.pset1'],
      saber:['submetido com nota ≥70%'] },
  ]},
  ...
  { id:'cs50.w3', t:'Week 3 — Algorithms', nota:'Cruza com a trilha de algoritmos. Se você já fez lá, aqui é só o pset.', filhos:[
    ...
    { id:'cs50.w3.plur', t:'Pset 3 — Plurality', min:90, pre:['cs50.w3.lab'],
      saber:['submetido com nota ≥70%'] },
    { id:'cs50.w3.run', t:'Pset 3 — Runoff', min:90, pre:['cs50.w3.plur'],
      saber:['submetido com nota ≥70%'] },
    { id:'cs50.w3.tide', t:'Pset 3 — Tideman (opcional)', min:90, pre:['cs50.w3.run'],
  ...
  { id:'cs50.w4', t:'Week 4 — Memory', nota:'O núcleo do valor do CS50 para quem só programou em linguagem gerenciada.', filhos:[
    { id:'cs50.w4.hex', t:'Hexadecimal e endereços', min:20,
      saber:['ler um endereço e um dump hexadecimal'] },
    { id:'cs50.w4.ptr', t:'Ponteiros', min:20, pre:['cs50.w4.hex'],
      saber:['declarar, desreferenciar e passar por referência','aritmética de ponteiro'] },
    { id:'cs50.w4.heap', t:'malloc, free, pilha vs heap', min:20, pre:['cs50.w4.ptr'],
    ...
    { id:'cs50.w4.io', t:'Arquivos, fread/fwrite e valgrind', min:20, pre:['cs50.w4.heap'],
      saber:['ler e escrever binário','interpretar a saída do valgrind'] },
    { id:'cs50.w4.lab', t:'Lab 4 — Volume', min:60, pre:['cs50.w4.io'],
      saber:['submetido e aprovado'] },
    { id:'cs50.w4.filter', t:'Pset 4 — Filter', min:90, pre:['cs50.w4.lab'],
      saber:['submetido com nota ≥70%'] },
    { id:'cs50.w4.rec', t:'Pset 4 — Recover', min:90, pre:['cs50.w4.filter'],
  ...
  { id:'cs50.w5', t:'Week 5 — Data Structures', nota:'Cruza forte com a trilha de algoritmos — faça as duas juntas se puder.', filhos:[
    { id:'cs50.w5.ll', t:'Listas ligadas em C', min:20, pre:['cs50.w4.heap'],
      saber:['inserir e liberar a lista inteira sem vazar'] },
    { id:'cs50.w5.tree', t:'Árvores e tries', min:20, pre:['cs50.w5.ll'],
      saber:['por que uma trie troca memória por tempo'] },
    { id:'cs50.w5.hash', t:'Tabelas hash e colisão', min:20, pre:['cs50.w5.tree'],
      saber:['encadeamento e fator de carga'] },
    { id:'cs50.w5.lab', t:'Lab 5 — Inheritance', min:60, pre:['cs50.w5.ll'],
      saber:['submetido e aprovado'] },
    { id:'cs50.w5.sp1', t:'Pset 5 — Speller: carregar e verificar', min:90, pre:['cs50.w5.hash'],
      saber:['dicionário carregado em hash, verificação funcionando'] },
    { id:'cs50.w5.sp2', t:'Pset 5 — Speller: liberar e otimizar', min:90, pre:['cs50.w5.sp1'],
  ...
  { id:'cs50.w6', t:'Week 6 — Python', nota:'Você já programa. Aqui é tradução de sintaxe e o contraste com C.', filhos:[
    ...
    { id:'cs50.w6.dna', t:'Pset 6 — DNA', min:90, pre:['cs50.w6.sent'],
      saber:['submetido com nota ≥70%'] },
  ]},
  ...
  { id:'cs50.w7', t:'Week 7 — SQL', nota:'Se você já escreve SQL, a aula é revisão. Fiftyville vale por si.', filhos:[
    ...
    { id:'cs50.w7.fifty', t:'Pset 7 — Fiftyville', min:90, pre:['cs50.w7.mov'],
  ...
  { id:'cs50.w9', t:'Week 9 — Flask', nota:'Padrão MVC e sessão. Finance é o pset mais longo do curso.', filhos:[
    ...
    { id:'cs50.w9.fin2', t:'Pset 9 — Finance: venda, histórico e portfólio', min:90, pre:['cs50.w9.fin1'],
      saber:['submetido com nota ≥70%'] },
  ]},

  { id:'cs50.fp', t:'Projeto final', nota:'O último requisito do certificado. Escolha algo que também sirva ao portfólio.', filhos:[
    { id:'cs50.fp.ideia', t:'Definir escopo e proposta', min:60, pre:['cs50.w9.fin2'],
      saber:['problema real, escopo que cabe em ~3 semanas','proposta submetida se o curso exigir'] },
    { id:'cs50.fp.b1', t:'Construção — núcleo funcional', min:90, pre:['cs50.fp.ideia'],
      saber:['o caminho principal funciona ponta a ponta'] },
    { id:'cs50.fp.b2', t:'Construção — completar e tratar erro', min:90, pre:['cs50.fp.b1'],
      saber:['casos de erro tratados, sem tela quebrada'] },
    { id:'cs50.fp.b3', t:'Construção — polimento e README', min:90, pre:['cs50.fp.b2'],
      saber:['README com o que é, como rodar e por que as escolhas'] },
    { id:'cs50.fp.video', t:'Vídeo de demonstração', min:60, pre:['cs50.fp.b3'],
    ...
    { id:'cs50.fp.sub', t:'Submissão e certificado', min:60, pre:['cs50.fp.video'],

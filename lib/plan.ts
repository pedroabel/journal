...
['A dívida é prioridade — e a escada é quem paga por isso','Os R$10.000 têm dinheiro próprio (R$1.200/mês, além dos R$2.500), então em mês normal nada atrasa e o intake de set/2028 segue de pé. Em mês apertado quem cede é o intercâmbio, não a dívida. <b>O preço disso não é vago:</b> a escada não tem folga — 24 depósitos cheios chegam aos R$60.000 em cima da hora de comprovar fundos, e cada mês sem os R$2.500 empurra a comprovação, que é o que trava visto e passagem. Por isso a planilha de custos reais (marco de set/2026) virou urgente: é ela que diz quanta folga existe de verdade, em vez de supor que existe.'],
...
export const PLAN_CTX ='Abel, dev full-stack (eng. computação), Brasil. Objetivo: emigrar para a Irlanda via curso nível 9 (PgDip/mestrado), intake alvo setembro/2028 com plano B janeiro/2029, usando o Stamp 1G de 24 meses. Rotina: janela do almoço (~20min, máx 3 dias/semana) e janela da noite 20:00-22:40 (chega 19h, dorme ~23h). Inglês: C2 na compreensão, gargalo é produção e vergonha de falar. CS50 pelo certificado. DSA para entrevistas. Poupança R$2.500/mês para o intercâmbio, mais R$1.200/mês para uma reserva pessoal de R$10.000 tratada como dívida (fecha ~mai/2027). As duas correm juntas: R$3.700/mês saindo, e em mês normal a escada do visto não atrasa. Em mês apertado a dívida tem prioridade e quem cede é o intercâmbio — e como a escada não tem folga (24 depósitos cheios batem os R$60.000 em cima da data de comprovar fundos), cada mês assim empurra o visto. SinPro roda no expediente. Mora acompanhado: não tem mais tarefa fixa de casa nem marmita, mas ganhou demanda de convívio e ainda não sabe quanto vai ajudar em casa. Tem cachorras, nunca sustentou hábitos antes — consistência é o maior risco. Tem modo reduzido para semanas atípicas e um marco de experiência obrigatório por trimestre.';

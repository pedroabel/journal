...
steps:[['2min','<b>Anki em voz alta</b> — responda falando.'],['8min','<b>Shadowing</b>: 1–2min de áudio nativo, repetido por cima 3–4x.'],['10min','<b>Grave 5min</b> no degrau em que você está: ler um texto em voz alta → recontar sem olhar o que acabou de ler → tema livre. Ouça e anote 2 pontos.']],
metodo:'Escada de produção — ler, imitar, recontar, falar livre — com auto-avaliação por gravação.',porque:'Sua barreira é vergonha, não conhecimento, e monólogo livre é o topo da escada, não a entrada. Ler em voz alta já grava som, ritmo e acento sem exigir que você invente o que dizer; sobe-se um degrau quando o de baixo fica fácil.',
recursos:['Um texto de ~350 palavras','Podcasts / YouTube / séries','Gravador do celular','Anki'],sucesso:'Shadowing 3–4x + 5min gravados + 2 pontos anotados.',revisao:'Os 2 pontos viram foco do shadowing seguinte.'},
